...
export function mimeTypeFromAssetPath(assetPath: string | null | undefined) {
...
export function getTableDocumentAssetsFromProject(
  ...
  if (key === 'dniFront' || key === 'dniBack') return getOriginalDocumentAssetsFromProject(project, 'dni');
  return [];
}
